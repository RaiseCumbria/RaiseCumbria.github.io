...
var format_CCFWoodlandcreation202425_3 = new ol.format.GeoJSON();
var features_CCFWoodlandcreation202425_3 = format_CCFWoodlandcreation202425_3.readFeatures(json_CCFWoodlandcreation202425_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_CCFWoodlandcreation202425_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_CCFWoodlandcreation202425_3.addFeatures(features_CCFWoodlandcreation202425_3);
var lyr_CCFWoodlandcreation202425_3 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_CCFWoodlandcreation202425_3, 
                style: style_CCFWoodlandcreation202425_3,
                popuplayertitle: "CCF Woodland creation 2024/25",
                interactive: true,
                title: '<img src="styles/legend/CCFWoodlandcreation202425_3.png" /> CCF Woodland creation 2024/25'
            });


var format_CCFWoodlandcreation202526_4 = new ol.format.GeoJSON();
var features_CCFWoodlandcreation202526_4 = format_CCFWoodlandcreation202526_4.readFeatures(json_CCFWoodlandcreation202526_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_CCFWoodlandcreation202526_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_CCFWoodlandcreation202526_4.addFeatures(features_CCFWoodlandcreation202526_4);
var lyr_CCFWoodlandcreation202526_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_CCFWoodlandcreation202526_4, 
                style: style_CCFWoodlandcreation202526_4,
                popuplayertitle: "CCF Woodland creation 2025/26",
                interactive: true,
                title: '<img src="styles/legend/CCFWoodlandcreation202526_4.png" /> CCF Woodland creation 2025/26'
            });
...
lyr_OpenStreetMap_0.setVisible(true);lyr_Plantingopportunity_1.setVisible(true);lyr_CCFWoodlandcreation202223_2.setVisible(true);lyr_CCFWoodlandcreation202324_3.setVisible(true);lyr_CCFWoodlandcreation202425_3.setVisible(true);lyr_CCFWoodlandcreation202526_4.setVisible(true);lyr_Casestudy_5.setVisible(true);

var layersList = [lyr_OpenStreetMap_0,lyr_Plantingopportunity_1,lyr_CCFWoodlandcreation202223_2,lyr_CCFWoodlandcreation202324_3,lyr_CCFWoodlandcreation202425_3,lyr_CCFWoodlandcreation202526_4,lyr_Casestudy_5];
...
lyr_CCFWoodlandcreation202425_3.set('fieldAliases', {'fid': 'fid', 'SITE_ID': 'Site ID', 'Name': 'Name', 'Site_ID_2': 'Site_ID_2', 'Gross Area (ha)': 'Gross area (ha)', 'Net Area (ha)': 'Net area (ha)', 'Spp category': 'Species', 'Public Access': 'Access', 'Planting type': 'Planting type', 'Trees Planted': 'Trees planted', 'metres hedgerow': 'Hedgerow metres', 'Km of footpaths': 'Km of footpaths', });
lyr_CCFWoodlandcreation202526_4.set('fieldAliases', {'fid': 'fid', 'Area_ha': 'Area_ha', 'Site ID': 'Site ID', 'Site Name': 'Name', 'Season': 'Season', 'Plant_Type': 'Plant_Type', 'Name': 'Site name', 'Site_ID': 'Site_ID', 'Gross Area (ha)': 'Gross area (ha)', 'Net Area (ha)': 'Net area (ha)', 'Access': 'Access', 'Planting type': 'Planting type', 'Spp category': 'Species', 'Trees Planted': 'Trees Planted', 'Hedgerow Trees Planted': 'Hedgerow Trees Planted', 'TOTAL TREES PLANTED': 'Trees planted', 'Metres Hedgerow': 'Hedgerow metres', });
...
lyr_CCFWoodlandcreation202425_3.set('fieldImages', {'fid': 'TextEdit', 'SITE_ID': '', 'Name': '', 'Site_ID_2': '', 'Gross Area (ha)': '', 'Net Area (ha)': '', 'Spp category': '', 'Public Access': '', 'Planting type': '', 'Trees Planted': '', 'metres hedgerow': '', 'Km of footpaths': '', });
lyr_CCFWoodlandcreation202526_4.set('fieldImages', {'fid': 'TextEdit', 'Area_ha': 'TextEdit', 'Site ID': 'TextEdit', 'Site Name': 'TextEdit', 'Season': 'TextEdit', 'Plant_Type': 'TextEdit', 'Name': '', 'Site_ID': '', 'Gross Area (ha)': '', 'Net Area (ha)': '', 'Access': '', 'Planting type': '', 'Spp category': '', 'Trees Planted': '', 'Hedgerow Trees Planted': '', 'TOTAL TREES PLANTED': '', 'Metres Hedgerow': '', });
...
lyr_CCFWoodlandcreation202425_3.set('fieldLabels', {'fid': 'hidden field', 'SITE_ID': 'inline label - visible with data', 'Name': 'inline label - visible with data', 'Site_ID_2': 'hidden field', 'Gross Area (ha)': 'inline label - visible with data', 'Net Area (ha)': 'inline label - visible with data', 'Spp category': 'inline label - visible with data', 'Public Access': 'inline label - visible with data', 'Planting type': 'inline label - visible with data', 'Trees Planted': 'inline label - visible with data', 'metres hedgerow': 'inline label - visible with data', 'Km of footpaths': 'hidden field', });
lyr_CCFWoodlandcreation202526_4.set('fieldLabels', {'fid': 'hidden field', 'Area_ha': 'hidden field', 'Site ID': 'inline label - visible with data', 'Site Name': 'hidden field', 'Season': 'hidden field', 'Plant_Type': 'hidden field', 'Name': 'inline label - visible with data', 'Site_ID': 'hidden field', 'Gross Area (ha)': 'inline label - visible with data', 'Net Area (ha)': 'inline label - visible with data', 'Access': 'inline label - visible with data', 'Planting type': 'inline label - visible with data', 'Spp category': 'inline label - visible with data', 'Trees Planted': 'hidden field', 'Hedgerow Trees Planted': 'hidden field', 'TOTAL TREES PLANTED': 'inline label - visible with data', 'Metres Hedgerow': 'inline label - visible with data', });
