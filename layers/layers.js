...
lyr_CCFWoodlandcreation202223_2.set('fieldImages', {'fid': 'TextEdit', 'SITE_ID': 'TextEdit', 'Name': 'TextEdit', 'Gross Area (ha)': 'TextEdit', 'Net Area (ha)': 'TextEdit', 'Access': 'TextEdit', 'Planting type': 'TextEdit', 'Trees Planted': 'Range', 'metres hedgerow': 'Range', });
lyr_CCFWoodlandcreation202324_3.set('fieldImages', {'fid': 'TextEdit', 'SITE_ID': 'TextEdit', 'Name': 'TextEdit', 'Gross Area (ha)': 'TextEdit', 'Net Area (ha)': 'TextEdit', 'Access': 'TextEdit', 'Planting type': 'TextEdit', 'Trees Planted': 'TextEdit', 'metres hedgerow': 'TextEdit', });
...
lyr_CCFWoodlandcreation202223_2.set('fieldLabels', {'fid': 'hidden field', 'SITE_ID': 'hidden field', 'Name': 'inline label - visible with data', 'Gross Area (ha)': 'inline label - visible with data', 'Net Area (ha)': 'inline label - visible with data', 'Access': 'inline label - visible with data', 'Planting type': 'inline label - visible with data', 'Trees Planted': 'inline label - visible with data', 'metres hedgerow': 'inline label - visible with data', });
lyr_CCFWoodlandcreation202324_3.set('fieldLabels', {'fid': 'hidden field', 'SITE_ID': 'hidden field', 'Name': 'inline label - visible with data', 'Gross Area (ha)': 'inline label - visible with data', 'Net Area (ha)': 'inline label - visible with data', 'Access': 'inline label - visible with data', 'Planting type': 'inline label - visible with data', 'Trees Planted': 'inline label - visible with data', 'metres hedgerow': 'inline label - visible with data', });
